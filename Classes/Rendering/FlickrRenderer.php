...
class FlickrRenderer implements FileRendererInterface
{
    ...
    {
        return ($file->getMimeType() === 'image/flickr' || $file->getExtension() === 'flickr') && $this->getOnlineMediaHelper($file) !== false;
    }
    ...
    {
        // todo check why no omitscript is there
        return sprintf('https://www.flickr.com/services/oembed?url=%s&omitscript=true&format=json',
            urlencode($mediaId)
        );
    }
